...
from transactions.forms import (DepositForm, WithdrawForm,LoanForm)
...
class WithdrawMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, f'{"{:,.2f}".format(float(amount))}$ from your account ')
        return super().form_valid(form)
...
class LoanRequestView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, f'{"{:,.2f}".format(float(amount))}$ loan requested successfully')
        return super().form_valid(form)
